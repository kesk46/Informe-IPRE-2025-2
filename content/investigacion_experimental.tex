...
\begin{center}
    \LARGE
    \textbf{IPRE 2025-2 Modulador Láser(?)}
...
El objetivo de la investigación consiste en implementar un módulo de filtro móvil al montaje del láser. 
Este incluirá un filtro de densidad neutra NDL-10C-2.
Después de un proceso de selección de formas de desplazamiento para aprovechar 
la densidad óptica (OD) variable que tiene el filtro, se optó por usar un sistema de stepper ensamblado con piezas impresas en 3D.
Se diseñó un sistema eléctrico conectado a una placa arduino para poder controlar su desplazamiento con un joystick. \\
Resultados: \\
Conclusiones: \\

(ESTO ES PROVISIONAL, LA REDACCIÓN ESTA HORRIBLE, PERO SON LOS PUNTOS PRINCIPALES ANTES DE REREDACTAR, CONFÍE)
...
\subsection{Decisión sistema desplazamiento}

Decir que evaluamos opciones que incluían sistemas de pistones, stepper o servos.
INCLUIR CÁLCULOS DE DESPLAZAMIENTOS, TORQUE Y FUERZA. (i got it)

\subsection{Sistema eléctrico y conexiones}

\subsection{Impresiones 3D}
